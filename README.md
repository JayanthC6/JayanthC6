...
| :--- | :--- | :--- |
| **[NeuroSymbolic AI](./)** | `Python` `React` `TensorFlow` `XAI` | **MCA Final Year Project.** Explainable Brain Tumor Analysis through MRI Scans using Neurosymbolic AI. |
| **[Farmer Crop Suggestion](./)** | `FastAPI` `React` `MongoDB` | A full-stack system suggesting optimal crops for farmers based on soil data. |
| **[Smart Attendance](./)** | `Flask` `MySQL` | Automated attendance tracker using facial recognition/logging techniques. |
| **[Pathfinding Visualizer](./)** | `HTML` `CSS` `JavaScript` | Interactive visualization of DSA algorithms like Dijkstra and A*. |
| **[Crypto Price Tracker](./)** | `React` `Bootstrap` | **BCA Final Year Project.** Real-time cryptocurrency dashboard. |
